...
public class StudentServiceImpl implements StudentService {
    ...
    public boolean add(Student student) throws Exception {
        if (student == null || student.getName() == null || student.getSex() == null || student.getSno() == null
                ...
                || student.getTeacher() == null || student.getStu_class() == null || student.getStatus() == 0)  {
            return false;
        }
    ...
    public InputStream getInputStream() throws Exception {
        ...
        String[] title = new String[]{"姓名","性别","学号","班级","联系方式","家庭住址","宿舍号","班主任","状态"};
