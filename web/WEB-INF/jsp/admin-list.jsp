...
<head>
    ...
    <script>
        ...
        $("#serarch_btn").click(function () {
            ...
            location.href="${pageContext.request.contextPath}/findAllAdmin?page=1&size=10&keyword="+keyword;
        });
        $("#refresh").click(function () {
            $("#myform").reset();
            location.href="${pageContext.request.contextPath}/findAllAdmin?page=1&size=10";
        });
    </script>
</head>
<body>
                ...
                <div class="layui-card-body ">
                    <form id="myform" class="layui-form layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block x-right">
                            <a class="layui-btn layui-btn-normal" href="${pageContext.request.contextPath}/findAllAdmin?page=1&size=10"><i class="layui-icon">&#xe669;</i></a>
                        </div>
                    </form>
                </div>
                <xblock>
