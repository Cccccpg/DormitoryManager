...
<head>
    ...
    <script>
        ...
        $("#serarch_btn").click(function () {
            ...
            location.href="${pageContext.request.contextPath}/dorm/findAll?page=1&size=10&keyword="+keyword;
        });
        $("#refresh").click(function () {
            $("#myform").reset();
            location.href="${pageContext.request.contextPath}/dorm/findAll?page=1&size=10";
        });
    </script>
</head>
<body>
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <table class="layui-table layui-form" id="dorm-list" lay-filter="demo" style=" table-layout: fixed;width: 100%">
                        <thead>
                        <tr style="text-align: center">
                            <th lay-data="{field:'id',sort:true}" style="text-align: center" >ID</th>
                            <th lay-data="{field:'dorm_id',sort:true}" style="text-align: center">宿舍号</th>
