...
<head>
    ...
    <script>
        ...
        $("#serarch_btn").click(function () {
            ...
            location.href="${pageContext.request.contextPath}/visitor/findAll?page=1&size=10&keyword="+keyword;
        });
        $("#refresh").click(function () {
            $("#myform").reset();
            location.href="${pageContext.request.contextPath}/visitor/findAll?page=1&size=10";
        });
    </script>
</head>
<body>
                ...
                <div class="layui-card-body ">
                    <form id="myform" class="layui-form layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block x-right">
                            <a class="layui-btn layui-btn-normal" href="${pageContext.request.contextPath}/visitor/findAll?page=1&size=10"><i class="layui-icon">&#xe669;</i></a>
                        </div>
                    </form>
                </div>
                <xblock>
                ...
                <div class="layui-card-body">
                    <table class="layui-table layui-form">
                        ...
                        <tr id="light" style="text-align: center">
                            ...
                            <c:if test="${sessionScope.adminInfo.power > 2}">
                                <td class="td-manage">
                                    <a title="访客离开" onclick="toUpdate('${visitor.id}');"  href="javascript:;">
...
<script>
    ...
    function toUpdate(id) {
        layer.confirm('确定访客已经离开吗',function (index) {
            layer.close(index);
