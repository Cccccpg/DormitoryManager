                ...
                <div class="layui-card-body ">
                    <%--<form id="myform" class="layui-form layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block x-right">
                            <a class="layui-btn layui-btn-normal" href="${pageContext.request.contextPath}/dorm/findStudent?name=${sessionScope.adminInfo.name}&page=1&size=10"><i class="layui-icon">&#xe669;</i></a>
                        </div>
                    </form>--%>
                </div>
                <xblock>
